...
If you choose to inherit from ``Any`` in ``Build_Instrument.xlsx``, Instrument will be like security type. Or you inherit from ``Index`` or ``Curve``, etc. Instrument will be like what you choose.
...
**Notice: However, any created instrument will remain unless you delete the class file manually.**
